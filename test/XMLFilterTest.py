...
if __name__ == "__main__":
    ...
    # OK
    test__filter_xml_tree("filter_in.xml", "filter_out.xml", [ConditionalTuple("paycompensation_recurring", "pay_component", operator.eq, "US_2_1003")])

    # OK, but empty tags are present (See todo in doc)
    test__filter_xml_tree("filter_in.xml", "filter_out2.xml", [ConditionalTuple("paycompensation_recurring", "pay_component", operator.eq, "US_2_1003"),
